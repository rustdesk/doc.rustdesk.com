...
`Pro` 사용자로서, [web console](/docs/ko/self-host/rustdesk-server-pro/console/)에서 `Key`를 추가로 가져올 수 있습니다.
...
1. [above](/docs/ko/self-host/client-configuration/#2-수동-구성) 단계를 사용하여 디바이스에 RustDesk 클라이언트를 구성하십시오.
...
자동으로 설정하는 가장 쉬운 방법은 [here](/docs/ko/self-host/client-deployment/)에서 찾을 수 있는 배포 스크립트를 사용하는 것입니다.
