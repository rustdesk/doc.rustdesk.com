...
- **유형**: 원격 데스크탑, 파일 전송, 포트 포워딩, 카메라 보기, 터미널 또는 로그인하지 않음. **로그인하지 않음** 은 인증에 성공하지 않았음을 의미합니다.
...
[API token](/docs/ko/self-host/rustdesk-server-pro/console/#감사-auditspy) 과 `audits.py` 를 사용해 감사 로그를 조회할 수도 있습니다.
