...
- **タイプ**: リモートデスクトップ、ファイル転送、ポート転送、カメラを表示、ターミナル、またはログインしていません。**ログインしていません** は、認証に成功しなかったことを意味します。
...
[API token](/docs/ja/self-host/rustdesk-server-pro/console/#監査-auditspy) と `audits.py` を使用して監査ログを照会することもできます。
