...
| Miglior punto di partenza   | Server community gratuito per una valutazione di base; valutazione di Server Pro tramite [sales@rustdesk.com](mailto:sales@rustdesk.com) per le funzionalità di gestione         | Prova SaaS per i team che desiderano un servizio gestito          | Vendita diretta e una valutazione infrastrutturale mirata                                                                                                                |
