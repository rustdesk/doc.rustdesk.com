...
| Melhor ponto de partida    | Servidor comunitário gratuito para avaliação básica; avaliação do Server Pro via sales@rustdesk.com para recursos de gerenciamento                                        | Teste gratuito do SaaS para equipes que desejam um serviço gerenciado | Venda direta e uma avaliação de infraestrutura com escopo definido                                                                           |
