...
Yes—you can upgrade your RustDesk license mid-subscription to add more [managed devices](/blog/what-counts-as-a-managed-device) or users whenever your team grows. Upgrades are allowed at any time and are prorated, so you only pay for the difference for the remainder of your term.
