...
| Mejor punto de partida     | Servidor comunitario gratuito para una evaluación básica; evaluación de Server Pro a través de sales@rustdesk.com para funciones de gestión                                                 | Prueba SaaS para equipos que desean un servicio gestionado     | Ventas directas y una evaluación de infraestructura acotada                                                                                                             |
